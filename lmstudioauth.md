...
Token format note for LMSA integration: LM Studio tokens can include a colon and look like `sk-lm-xxxx:yyyy`.
Example: `sk-lm-7LOpOQVX:s3uFVkL8iDqEBomMck5w`
...
```bash
LM_API_TOKEN="sk-lm-7LOpOQVX:s3uFVkL8iDqEBomMck5w"
```
